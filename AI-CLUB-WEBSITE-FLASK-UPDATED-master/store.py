...
@store.route('/inductions',methods=['GET'])
def inductions():
    return render_template('inductions/index.html')

@store.route('/registers',methods=['GET'])
def registers():
    return render_template('register/register.html')

@store.route('/submissions',methods=['GET'])
def submissions():
    return render_template('submission/submission.html')
@store.route('/register_details',methods=['POST','GET'])
